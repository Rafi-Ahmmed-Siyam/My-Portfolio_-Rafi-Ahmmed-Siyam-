...
export default function AboutMe() {
   return (
      <section className="bg-slate-950 py-20 px-6 min-h-[70vh] flex items-center overflow-hidden ">
         <div className="w-300 mx-auto flex flex-col md:flex-row-reverse items-center justify-between gap-5 ">
            ...
            <div className="relative flex-1 flex justify-center items-center ">
               ...
               {/* <div className="absolute w-[320px] h-80 md:w-2xs md:h-72 bg-slate-900 rounded-full translate-x-10"></div> */}
            ...
            <div className="flex-1 text-center md:text-left ">
               ...
               <div className="flex flex-wrap justify-center md:justify-start gap-4">
                  ...
                  <Button
                     variant="outline"
                     className="border-2 border-slate-700 text-slate-200 hover:bg-slate-800 px-6 py-6 rounded-xl font-bold text-lg transition-all active:scale-95 gap-2"
                  >
